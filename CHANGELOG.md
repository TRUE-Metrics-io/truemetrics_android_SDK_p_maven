...
- Fixed a hardware sensor (accelerometer, gyroscope, magnetometer, barometer or step counter) silently recording nothing for a whole session when the device's sensor service failed to start it; the SDK now retries for up to about a minute and a half
