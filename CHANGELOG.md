...
- The SDK now records when it comes up and when it is shut down. An orderly shutdown writes a closing marker — its absence means the app was killed rather than closed. These two markers are the only events recorded outside a recording session
