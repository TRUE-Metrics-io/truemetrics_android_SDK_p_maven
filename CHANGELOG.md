...
- If device storage fills up before data can be uploaded, the oldest unsent readings are now dropped first so recording continues, instead of new data being lost
